...
stage1_batch_size = 32 # batch size for training, only used in stage 1
vst_base_batch_size = 32  # It can be adjusted based on the GPU memory used
...
if latest_path and latest_epoch:
    print(f">>> Tìm thấy checkpoint: epoch {latest_epoch} tại {latest_path}")
